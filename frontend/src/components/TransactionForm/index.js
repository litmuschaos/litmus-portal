...
export default function TransactionForm({
  ...
  return (
    <div className={className} style={{ minWidth: '300px' }}>
      {success && (
        <div className="py-4 px-8 mb-4 bg-black text-grey-lighter">Succesfully saved!</div>
      )}
      ...
      <Panel>
        ...
        <TextField
          label="Description"
          placeholder="Some description for this transaction"
        ...
        {cancelTransaction && (
          <Button onClick={cancelTransaction} variant="tertiary" className="ml-2">
            Cancel
          </Button>
        )}
      </Panel>
